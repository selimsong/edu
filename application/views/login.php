...
<html  lang="en">
	...
	<body>
		<div id="container">
			<form name="loginform" action="<?php  echo site_url('/login/validate'); ?>" method="post">
				...
				<div class="forgot-usr-pwd" style="color: red;font-size:16px;"><a href="<?php  echo site_url('/signup'); ?>">注册</a></div>
